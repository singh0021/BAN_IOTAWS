...
function infiniteLoopPublish(n) {
    console.log('Sending ban Body temperature data to AWS IoT for ' + deviceName);
    ...
    //setInterval(infiniteLoopPublish, 5000*12);
...
function getBanData(deviceName) {
    let message = {
        ...
        'Unit': 'Degree Celsius',
        'body_temperature_Celsius': randomFloatBetween(35.055, 37.55),
