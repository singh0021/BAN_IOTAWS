...
function infiniteLoopPublish() {
    console.log('Sending Blood Pressure data to AWS IoT for ' + deviceName);
...
function getBanData(deviceName) {
    let message = {
        ...
        'Stystolic_BP': randomFloatBetween(90.00, 140.55),
        'Diastolic_BP': randomFloatBetween(60.00, 90.55),
        'Unit': 'mmHG',
