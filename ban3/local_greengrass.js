...
function infiniteLoopPublish() {
    console.log('Sending ban Heart rate data to AWS IoT for ' + deviceName);
...
function getBanData(deviceName) {
    let message = {
        ...
        'Breathing_Rate': randomFloatBetween(12.00, 25.55),
        'Heart_Rate': randomFloatBetween(60.04, 110.00),
    ...
    const device_data = { 
        'ban3': {
            'vin': 'R5Z456789RZFU4YRM',
            'locations':'Heart',
            'Type':'Pacemaker'
        },
        'ban4': {
            'vin': 'ETWUA567IURZOPQRTR',
            'locations':'Chest',
            'Type':'ECG'
        }
    };
